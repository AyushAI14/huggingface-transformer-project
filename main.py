...
# from src.pipeline.stage_3_data_trainer import DataTrainerPipeline
from src.pipeline.stage_4_data_evalution import DataEvalutionPipeline
...
STAGE_NAME = 'Data Evaution stage'

try:
    logger.info(f'Initiating {STAGE_NAME} intiated')
    Data_trainer_Pipeline = DataEvalutionPipeline()
    Data_trainer_Pipeline.intiate_data_evalution()
    logger.info(f'{STAGE_NAME} initiated')
except Exception as e:
    logger.exception(e)
    raise e
